...
TypeRepairService.getTypeRepairById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    let [rows] = yield database_1.connection.query('SELECT * FROM tipo_refaccion WHERE ID_MARCA = ?', [parseInt(id)]);
    let users = rows.map((r) => {
        return r;
    });
    return users;
...
TypeRepairService.getTypeRepairStatus = (id) => __awaiter(void 0, void 0, void 0, function* () {
    let [rows] = yield database_1.connection.query('SELECT estatus FROM tipo_refaccion WHERE ID_MARCA = ?', [id]);
...
TypeRepairService.updateTypeRepair = (item, id) => __awaiter(void 0, void 0, void 0, function* () {
    const responseUpdate = yield database_1.connection.query('UPDATE tipo_refaccion SET ? WHERE ID_MARCA = ?', [item, id]);
