...
const tipoPersona_service_1 = require("../services/tipoPersona.service");
...
TypePersonController.getAll = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield tipoPersona_service_1.TypePersonService.getTypes();
        res.json(response);
    }
    catch (e) {
...
TypePersonController.getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield tipoPersona_service_1.TypePersonService.getTypeById(id_get);
        res.json(response);
    }
    catch (e) {
        res.status(500).json(e);
...
TypePersonController.insert = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield tipoPersona_service_1.TypePersonService.insertType(body);
...
TypePersonController.update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = req.body;
        yield tipoPersona_service_1.TypePersonService.updateType(data, id);
