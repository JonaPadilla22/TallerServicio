...
const tipoServicio_service_1 = require("../services/tipoServicio.service");
...
ServiceTypeController.getAll = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield tipoServicio_service_1.ServiceTypeService.getServices();
        res.json(response);
    }
    catch (e) {
...
ServiceTypeController.getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield tipoServicio_service_1.ServiceTypeService.getServiceById(id_get);
        res.json(response);
    }
    catch (e) {
        res.status(500).json(e);
...
ServiceTypeController.insert = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield tipoServicio_service_1.ServiceTypeService.insertService(body);
...
ServiceTypeController.update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = req.body;
        yield tipoServicio_service_1.ServiceTypeService.updateService(data, id);
