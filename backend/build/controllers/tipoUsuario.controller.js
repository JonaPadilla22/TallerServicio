...
const tipoUsuario_service_1 = require("../services/tipoUsuario.service");
...
UserTypeController.getAll = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield tipoUsuario_service_1.UserTypeService.getUserTypes();
        res.json(response);
    }
    catch (e) {
...
UserTypeController.getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield tipoUsuario_service_1.UserTypeService.getUserTypeById(id_get);
        res.json(response);
    }
    catch (e) {
        res.status(500).json(e);
...
UserTypeController.insert = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield tipoUsuario_service_1.UserTypeService.insertUserType(body);
...
UserTypeController.update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = req.body;
        yield tipoUsuario_service_1.UserTypeService.updateUserType(data, id);
