...
ModelController.getAll = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield model_service_1.ModelService.getModels();
        res.json(response);
    }
    catch (e) {
...
ModelController.getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield model_service_1.ModelService.getModelById(id_get);
        res.json(response);
    }
    catch (e) {
        res.status(500).json(e);
...
ModelController.insert = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield model_service_1.ModelService.insertModel(body);
...
ModelController.update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = req.body;
        yield model_service_1.ModelService.updateModel(data, id);
