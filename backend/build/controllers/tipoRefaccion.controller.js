...
const tipoRefaccion_service_1 = require("../services/tipoRefaccion.service");
...
RepairTypeController.getAll = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield tipoRefaccion_service_1.TypeRepairService.getTypeRepairs();
        res.json(response);
    }
    catch (e) {
...
RepairTypeController.getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield tipoRefaccion_service_1.TypeRepairService.getTypeRepairById(id_get);
        res.json(response);
    }
    catch (e) {
        res.status(500).json(e);
...
RepairTypeController.insert = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield tipoRefaccion_service_1.TypeRepairService.insertTypeRepair(body);
...
RepairTypeController.update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = req.body;
        yield tipoRefaccion_service_1.TypeRepairService.updateTypeRepair(data, id);
