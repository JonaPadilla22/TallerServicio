...
BrandController.getAll = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield marca_service_1.BrandService.getBrands();
        res.json(response);
    }
    catch (e) {
...
BrandController.getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield marca_service_1.BrandService.getBrandById(id_get);
        res.json(response);
    }
    catch (e) {
        res.status(500).json(e);
...
BrandController.insert = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield marca_service_1.BrandService.insertBrand(body);
...
BrandController.update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = req.body;
        yield marca_service_1.BrandService.updateBrand(data, id);
