...
const manoDeObra_service_1 = require("../services/manoDeObra.service");
...
ManoDeObraController.getAll = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield manoDeObra_service_1.ManoDeObraService.getWorkforces();
        res.json(response);
    }
    catch (e) {
...
ManoDeObraController.getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield manoDeObra_service_1.ManoDeObraService.getWorkforceById(id_get);
        res.json(response);
    }
    catch (e) {
        res.status(500).json(e);
...
ManoDeObraController.insert = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield manoDeObra_service_1.ManoDeObraService.insertWorkforce(body);
...
ManoDeObraController.update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = req.body;
        yield manoDeObra_service_1.ManoDeObraService.updateWorkforce(data, id);
